...
namespace CryptoSoft2._0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string configFolderPath = System.IO.Path.GetFullPath(@"..\Cryptosoft\Key");
            string cryptoKeyPath = System.IO.Path.GetFullPath(@"..\Cryptosoft\Key\keyfile.txt");

            // Path of the json configFile of EasySave
            string configFilePath = System.IO.Path.GetFullPath(@"..\Cryptosoft\Key\config.json");
